...
struct common_params {
    ...
    int32_t n_ctx_checkpoints   = 0;     // max number of context checkpoints per slot (0 = disable)
    int32_t checkpoint_every_nt = -1;    // make a checkpoint every n tokens during prefill (-1 = disable)
